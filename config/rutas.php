...
return [
    ...
    'inventario' => [
        'titulo' => 'Inventario',
        'icono' => '<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7 12 3 4 7m16 0-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>',
        'route' => 'inventario.dashboard',
        'breadcrumb_label' => 'Inventario',
        'permisos_modulo' => 'acceso-inventario',
        'items' => [
            [
                'titulo' => 'Dashboard',
                'route' => 'inventario.dashboard',
                'routes' => ['inventario.dashboard'],
            ...
            [
                ...
                'permisos' => ['inventario.productos.ver'],
                'icono' => '',
                'breadcrumb' => true,
            ],
            [
                ...
                'routes' => ['inventario.bodegas'],
                'permisos' => ['inventario.bodegas.ver'],
                'icono' => '',
                'breadcrumb' => true,
            ],
            [
                ...
                'permisos' => ['inventario.existencias.ver'],
                'icono' => '',
                'breadcrumb' => true,
            ],
            [
            ...
            [
                ...
                'routes' => ['inventario.kardex'],
                'permisos' => ['inventario.kardex.ver'],
                'icono' => '',
                'breadcrumb' => true,
            ],
        ],

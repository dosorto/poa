<x-dialog-modal maxWidth="lg" wire:model="isImportModalOpen">
    <x-slot name="title">
        {{ __('Importar CUBS desde Excel') }}
    </x-slot>
    ...
    <x-slot name="content">
        <div class="space-y-4">
            ...
            <div class="rounded-md bg-zinc-50 p-3 text-sm text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300">
                ...
                <p class="mt-1 font-mono text-xs">IDUNSPSC,descripcion_esp,descripcion_regional</p>
            </div>
    ...
    <x-slot name="footer">
        <div class="flex justify-end space-x-2">
            <x-spinner-secondary-button
                ...
                type="button"
                loadingTarget="closeImportModal"

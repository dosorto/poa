...
<x-dialog-modal wire:model.live="showDeleteTareaModal" maxWidth="md">
    <x-slot name="title">
                ...
                <div class="mt-4 p-4 bg-zinc-50 dark:bg-zinc-800 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-zinc-500 dark:text-zinc-400">
                                Correlativo: {{ $tareaToDelete->correlativo }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-yellow-700 dark:text-yellow-200">
                            Esta acción no se puede deshacer. Se eliminarán permanentemente la tarea y todos sus datos
                            asociados.
                        </p>
                    </div>
                </div>
    ...
    <x-slot name="footer">
        <x-secondary-button wire:click="closeDeleteTareaModal">
            Cancelar
        </x-secondary-button>

        <x-danger-button class="ml-3" wire:click="confirmDeleteTarea">
            Eliminar
        </x-danger-button>
    </x-slot>
</x-dialog-modal>
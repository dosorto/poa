                                                            ...
                                                            <td class="px-4 py-3">
                                                                <div class="flex gap-2 justify-center">
                                                                    <button wire:click="aprobarTarea({{ $tarea->id }})"
                                                                        ...
                                                                        class="inline-flex items-center px-3 py-1.5 bg-green-600 hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white text-xs font-semibold rounded-md transition cursor-pointer">
                                                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                                            <path fill-rule="evenodd"

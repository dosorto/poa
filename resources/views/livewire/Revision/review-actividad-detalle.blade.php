        ...
        <div class="bg-white dark:bg-zinc-900 overflow-hidden shadow sm:rounded-lg p-4 sm:p-6">
            ...
            <div class="mb-6 pb-4 border-b border-zinc-200 dark:border-zinc-700">
                <div class="flex items-center justify-between">
                    <div>
                        <a href="{{ route('revisiones', ['showActividades' => 1, 'departamentoId' => $actividad->idDeptartamento, 'poaYear' => $actividad->poa?->anio]) }}" wire:navigate
                            ...
                            Volver a Actividades del Departamento
                        </a>
                                                            ...
                                                            <td class="px-4 py-3">
                                                                <div class="flex gap-2 justify-center">
                                                                    <button wire:click="aprobarTarea({{ $tarea->id }})"
                                                                        class="inline-flex items-center px-3 py-1.5 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded-md transition cursor-pointer @if($tarea->estado === 'APROBADO') opacity-50 cursor-not-allowed @endif"
                                                                        @if($tarea->estado === 'APROBADO') disabled @endif>
                                                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                                            <path fill-rule="evenodd"

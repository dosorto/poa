        ...
        <x-dialog-modal wire:model="showConfirmFinalizarModal" maxWidth="md">
            ...
            <x-slot name="footer">
                ...
                <x-spinner-button class="ml-3" wire:click="confirmarFinalizarRequisicion"
                    loadingTarget="confirmarFinalizarRequisicion" loadingText="Finalizando...">
                                ...
                                @if (($requisicion->estado->estado ?? '') !== 'Finalizado')
                                    ...
                                    @else
                                        <button wire:click="abrirModalEjecucion({{ $recurso['id'] }})"
                                            ...
                                            class="inline-flex items-center px-3 py-2 rounded-md text-sm font-medium bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition disabled:opacity-60 disabled:cursor-not-allowed">
                                            <span wire:loading.remove wire:target="abrirModalEjecucion({{ $recurso['id'] }})" class="inline-flex items-center">
                                            ...
                                            <span wire:loading wire:target="abrirModalEjecucion({{ $recurso['id'] }})" class="inline-flex items-center gap-2">

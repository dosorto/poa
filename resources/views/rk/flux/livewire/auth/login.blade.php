<div class="flex flex-col gap-6">
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        <!-- Email Address -->
        <flux:input wire:model="email" :label="__('Usuario o número de empleado')" type="text" required autofocus autocomplete="username"
            placeholder="juan.perez@ejemplo.com o 19898" />
